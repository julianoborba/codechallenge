...
public class StationVO { // Vertex
	...
	public StationVO(String stationId, int id, double latitude, double longitude, String name, String display_name, double zone, int total_lines, int rail) {
	...
	public String toString() {
		return "StationVO [stationId=" + stationId + ", id=" + id
				+ ", latitude=" + latitude + ", longitude=" + longitude
				+ ", name=" + name + ", display_name=" + display_name
				+ ", zone=" + zone + ", total_lines=" + total_lines + ", rail="
				+ rail + "]";
	}
	...
	public int hashCode() {
		...
		temp = Double.doubleToLongBits(zone);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (total_lines != other.total_lines)
			return false;
		if (Double.doubleToLongBits(zone) != Double
				.doubleToLongBits(other.zone))
			return false;
		return true;
	}

	public String toRedisString() {
		return id + "," + latitude + "," + longitude + "," + name+ "," + display_name + "," + zone + "," + total_lines + "," + rail;
	}
